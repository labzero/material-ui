...
var Menu = function (_Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props2, ['autoWidth', 'children', 'desktop', 'disableAutoFocus', 'initiallyKeyboardFocused', 'listStyle', 'maxHeight', 'multiple', 'onItemTouchTap', 'onEscKeyDown', 'selectedMenuItemStyle', 'style', 'value', 'valueLink', 'width']);
